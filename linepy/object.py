...
special_thanks = """
=========================
FGM SIMPLE SELFBOT v0.1
Create Date: 5/9/2020
Author: Hansen & UNYPASS

Special Thanks:
- HelloWorld
- BE-TEAM

COPYRIGHT FGM CORP 2020
========================="""
...
class Object(object):
    ...
    def __init__(self):
        if self.isLogin == True:
            print("[FGM SERVICE] SUCCESS CONNECT SELFBOT")
            print("[FGM SERVICE] ACCOUNT NAME: %s" % self.profile.displayName)
    ...
    @loggedIn
    def updateProfileVideoPicture(self, vid, pic):
        try:
            ...
            self.updateProfilePicture(pic, 'vp')
            self.deleteFile(pic)
            self.deleteFile(vid)
        except:
